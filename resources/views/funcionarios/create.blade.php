...
@section('content')
<h1 class="fs-2 mb-3"> Cadastro de funcionarios</h1>
<form class="row g-3">
    <div class="col-md-4">
    ...
    <div class="col md-7">
        ...
        <input type="email" class="form-control" id="email" name="email" maxlength="11" minlength="11" required>
      </div>
